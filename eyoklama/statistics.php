      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
			...
			<li class="active"><a href="statistics.php">İstatistikler</a></li>
      ...
      <?php
        ...
        if($classes != 0) {
          ...
          foreach($classes as $c) {
            $node = $n->retrieveObjecti($c,$teacher_id) or die("Kayıt bulunamadı");
          ...
          echo '<ul class="nav nav-tabs">
            <li class="active"><a href="#graph">Ortalama Katılım</a></li>
            <li><a href="#detained">Kısa Katılım</a></li>
          </ul>
          <div class="content">
            <div id="graph">
            </div>
