 ...
 <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="teacher.php">Panel</a></li>
  ...
  <div class="container">
    <?php
      ...
      echo '<h2>Hoşgeldin , '.$name.'.</h2>';
      echo '<div class="wrapper">';
      // FOR EACH CLASS , GET IT'S INFO AND PREPARE A LINK
      $n = new Node;
       
      if(!$classes) {
        echo '<h3 class="no-classes">Henüz açılmış sınıf yok!</h3>';
      } else { 
        echo '<h3 class="no-classes">Yoklama listesi oluşturmak için tıklayınız.</h3>';
        foreach($classes as $class_id) {
          $node = $n->retrieveObjecti($class_id,$teacher_id) or die("Kayıt yok!");
          $code = $node->getCode();
  ...
  <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="addClass" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <h2 class="text-center"> Sınıf Ekle </h2>
          <hr>
